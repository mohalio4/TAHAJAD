...
@section('title', 'مكتبة مسموعة - دليل إعداد Laravel')

@push('styles')
    <link rel="stylesheet" href="{{ asset('css/maktaba-masmouaa.css') }}">
@endpush
    ...
    <main class="maktaba-page">
        <div class="maktaba-container">
            ...
            <header class="maktaba-header glass-card">
                <h1 class="maktaba-title">مكتبة مسموعة</h1>
                <p class="maktaba-subtitle">دليل إعداد خدمة مكتبة الصوتيات Laravel</p>
                <p class="maktaba-description">Laravel Audio Library Service Setup Guide</p>
                <div class="maktaba-meta">
                    <span class="meta-item">📚 دليل تقني</span>
                    <span class="meta-item">🔧 Laravel Backend</span>
                    <span class="meta-item">📱 Flutter Integration</span>
                </div>
            </header>
            ...
            <div class="maktaba-content">
                ...
                <section class="content-section glass-card">
                    ...
                    <div class="section-content">
                        <p>يشرح هذا الدليل كيفية بناء خدمة backend لمكتبة الصوتيات باستخدام Laravel التي تتكامل مع تطبيق Flutter المحمول.</p>
                        <div class="info-box">
                ...
                <section class="content-section glass-card">
                    <h2 class="section-title">متطلبات API</h2>
                    <div class="section-content">
                        ...
                        <pre><code class="language-json">[
  {
    ...
    "type": "ad3eya"
                        ...
                        <div class="table-wrapper">
                            <table class="data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr><td><code>relation</code></td><td>string</td><td>Yes</td><td>Relation or context (e.g., "زيارة", "دعاء")</td></tr>
                        ...
                        <div class="types-grid">
                            <div class="type-card"><code>ad3eya</code> - أدعية وزيارات</div>
                            <div class="type-card"><code>majlis</code> - عزاء</div>
                            <div class="type-card"><code>aakida</code> - عقائد</div>
                            <div class="type-card"><code>sira</code> - سيرة</div>
                            <div class="type-card"><code>fokoh</code> - فقه</div>
                            <div class="type-card"><code>akhlak</code> - أخلاق</div>
                            <div class="type-card"><code>motnawe3</code> - متنوّع</div>
                            <div class="type-card"><code>quran</code> - قرآن</div>
                            <div class="type-card"><code>snasrollah</code> - الشّهيد السيد حسن نصرالله</div>
                        </div>
                    </div>
                </section>
                ...
                <section class="content-section glass-card">
                    <h2 class="section-title">تنفيذ Laravel</h2>
                    <div class="section-content">
...
// Audio Library API
Route::get('/catalog', [AudioController::class, 'catalog'])->name('api.audio.catalog');@endphp</code></pre>
                        </div>
                        ...
                        <div class="subsection">
                            ...
                            <pre><code class="language-php">@php'audio_base_url' => env('AUDIO_BASE_URL', env('APP_URL')),@endphp</code></pre>
                        </div>
                        ...
                        <div class="subsection">
                            ...
                            <pre><code class="language-php">@php'paths' => ['api/*'],
'allowed_methods' => ['*'],
'allowed_origins' => ['*'], // Or specify your Flutter app domains
'allowed_headers' => ['*'],@endphp</code></pre>
                        </div>
                    </div>
                </section>
                ...
                <section class="content-section glass-card">
                    <h2 class="section-title">المصادقة (اختياري)</h2>
                    <div class="section-content">
                        <p>إذا كنت تحتاج لحماية API بالمصادقة، يمكنك استخدام Laravel Sanctum أو API tokens:</p>
                        <pre><code class="language-php">@phpRoute::middleware('auth:sanctum')->get('/catalog', [AudioController::class, 'catalog']);@endphp</code></pre>
  ...
  'Accept': 'application/json',
                ...
                <section class="content-section glass-card">
                    <h2 class="section-title">إعدادات الخادم</h2>
                    <div class="section-content">
...
DB_PASSWORD=your_database_password</code></pre>
                ...
                <section class="content-section glass-card">
                    <h2 class="section-title">تخزين الملفات</h2>
                    <div class="section-content">
                        ...
                        <pre><code class="language-php">@php$audioPath = Storage::disk('s3')->url('audio/example.m4a');@endphp</code></pre>
                    </div>
                </section>
                
                <!-- Testing Section -->
                <section class="content-section glass-card">
                    <h2 class="section-title">اختبار API</h2>
                    <div class="section-content">
  ...
  -H "Accept: application/json"</code></pre>
                ...
                <section class="content-section glass-card">
                    <h2 class="section-title">ميزات إضافية (اختياري)</h2>
                    <div class="section-content">
...
public function catalog(): JsonResponse
{
    ...
    return response()->json($items);
                ...
                <!-- Security Section -->
                <section class="content-section glass-card">
                    <h2 class="section-title">اعتبارات الأمان</h2>
                    <div class="section-content">
                        <ul>
                        ...
                        <pre><code class="language-php">@phpRoute::middleware(['throttle:60,1'])->get('/catalog', [AudioController::class, 'catalog']);@endphp</code></pre>
                    </div>
                </section>
                ...
                <section class="content-section glass-card">
                    ...
                    <div class="section-content">
                        ...
                        <div class="warning-box">
                            <strong>⚠️ ملاحظة:</strong> استبدل القيم النائبة (URLs, passwords, tokens) ببياناتك الفعلية قبل النشر في الإنتاج.
                        </div>
                    </div>
                </section>
