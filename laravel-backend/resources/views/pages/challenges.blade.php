...
@section('content')
    ...
    <main class="challenges-main">
        <div class="challenges-container">
            ...
            <!-- All stat values are calculated dynamically by JavaScript - no hardcoded numbers -->
                        ...
                        <div class="ready-challenges-grid">
                            ...
                            <div class="ready-challenge-card" data-ready-challenge="prayer">
                                ...
                                <div class="ready-challenge-content">
                                    ...
                                    <p class="ready-challenge-desc">عن الإمام الصادق (عليه السلام) أنه قال: (مَنْ دَعَا إِلَى اللَّهِ أَرْبَعِينَ صَبَاحاً بِهَذَا الْعَهْدِ كَانَ مِنْ أَنْصَارِ قَائِمِنَا)</p>
    ...
    <!-- Day Challenges Modal (Shown when clicking calendar day) -->
