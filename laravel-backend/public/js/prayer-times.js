...
class PrayerTimesManager {
    ...
    showPrayerNotification() {
        ...
        if (Notification.permission === 'granted') {
            new Notification('حان وقت الصلاة', {
                ...
                icon: window.Laravel?.imagePaths?.tahajadLogo || '/assets/images/tahajad_logo.png',
                badge: window.Laravel?.imagePaths?.tahajadLogo || '/assets/images/tahajad_logo.png',
    ...
    playAdhan() {
        ...
        const audioPaths = [
            window.Laravel?.imagePaths?.adhan || '/assets/audio/adhan.mp3',
    ...
    triggerAlarm(prayerName, prayerNameArabic) {
        ...
        if ('Notification' in window && Notification.permission === 'granted') {
            const notification = new Notification('موعد الصلاة', {
                ...
                icon: window.Laravel?.imagePaths?.logo1 || '/assets/images/logo1.png',
                badge: window.Laravel?.imagePaths?.logo1 || '/assets/images/logo1.png',
